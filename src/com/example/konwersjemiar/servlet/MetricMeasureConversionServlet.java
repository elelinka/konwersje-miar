...
public class MetricMeasureConversionServlet extends HttpServlet {
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (!(meter.isEmpty()) && centimeter.isEmpty() && millimeter.isEmpty()) {
        ...
        } else if (!(centimeter.isEmpty()) && meter.isEmpty() && millimeter.isEmpty()) {
        ...
        } else if (!(millimeter.isEmpty()) && meter.isEmpty() && centimeter.isEmpty()) {
